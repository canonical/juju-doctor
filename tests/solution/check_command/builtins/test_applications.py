...
def test_builtin_failing_app_name_assertion():
    ...
    test_args = [
        ...
        "--verbose",
        "--format=json",
        "--probe=file://tests/resources/probes/ruleset/invalid/builtins/applications/failing-app-name.yaml",
...
def test_builtin_failing_max_assertion():
    # GIVEN a RuleSet with failing Applications assertions
    runner = CliRunner()
    test_args = [
        "check",
        "--verbose",
        "--format=json",
        "--probe=file://tests/resources/probes/ruleset/invalid/builtins/applications/failing-maximum.yaml",
        "--status=tests/resources/artifacts/status.yaml",
    ]
    # WHEN `juju-doctor check` is executed
    result = runner.invoke(app, test_args)
...
def test_builtin_failing_min_assertion():
    # GIVEN a RuleSet with failing Applications assertions
    runner = CliRunner()
    test_args = [
        "check",
        "--verbose",
        "--format=json",
        "--probe=file://tests/resources/probes/ruleset/invalid/builtins/applications/failing-minimum.yaml",
        "--status=tests/resources/artifacts/status.yaml",
    ]
    # WHEN `juju-doctor check` is executed
    result = runner.invoke(app, test_args)
